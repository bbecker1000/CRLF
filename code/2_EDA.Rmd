...
```{r}
canopy_emergent <- between_year_data %>% ggplot(aes(x=interpolated_canopy, y=mean_percent_emerg))+
  geom_point() +
  geom_smooth(method=lm)

canopy_emergent_model <- lm(mean_percent_emerg ~ interpolated_canopy, data = between_year_data)
