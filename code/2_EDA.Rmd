...
#this code has been updated. If anyone can help adding label info (the mean value) besides each point that would be great. Also should we only use data after 2010 and make a trend line?
ggplot(data = data)+ 
