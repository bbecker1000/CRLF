...
=======
  geom_smooth(aes(x = BRDYEAR, y = mean_interpolated_submerg), color = "turquoise3")
>>>>>>> c9ee606569bfb5f2813901bdb9d78ac635275a91
...
ggplot(data = between_year_data) + 
  ...
  geom_smooth(aes(x = BRDYEAR, y = mean_interpolated_open_water), color = "turquoise3")

# facet wrap by site
ggplot(data = between_year_data) + 
  geom_smooth(aes(x = BRDYEAR, y = mean_ground_sub), color = "salmon", se = FALSE) +
  geom_line(aes(x = BRDYEAR, y = mean_interpolated_submerg), color = "turquoise3") +
